...
zoommenu.add_radiobutton(label="100x", command=lambda : (scale.set(1),deletemoons(),updatemoons()))
zoommenu.add_radiobutton(label="200x", command=lambda : (scale.set(2),deletemoons(),updatemoons()))
zoommenu.add_radiobutton(label="300x", command=lambda : (scale.set(3),deletemoons(),updatemoons()))
zoommenu.add_radiobutton(label="400x", command=lambda : (scale.set(4),deletemoons(),updatemoons()))
